...
async def amireallyalive(alive):
    ...
    await alive.edit("`Currently Alive, my peru master!` **ψ(｀∇´)ψ**\n\n"
                     ...
                     "`Bot created by:` [SnapDragon](tg://user?id=719877937), @opgohil_bot\n"
                     f"`My peru owner`: {DEFAULTUSER}\n\n"
                     "many people use my videos and upload in youtube i tell you my official YouTube chennel is opgohil")
